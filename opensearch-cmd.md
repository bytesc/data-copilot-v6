...
docker run -d \
  ...
  -e "OPENSEARCH_INITIAL_ADMIN_PASSWORD=S202512sss" \
...
jdbc:opensearch://http://127.0.0.1:9200?auth=basic&user=admin&password=S202512sss&trustSelfSigned=true



curl -X GET "https://localhost:9200/_cluster/health" -ku admin:S202512sss

curl -X GET "http://localhost:9200/_cluster/health" -ku admin:S202512sss
